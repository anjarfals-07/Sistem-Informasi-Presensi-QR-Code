 ...
 * @author Anjar
 */
public class AbsensiKeluar extends javax.swing.JFrame implements Runnable, ThreadFactory {

    /**
     * Creates new form AbsensiKeluar
     */
    ...
    private void initComponents() {
        ...
        jLabel25.setText("Absensi Keluar");
        ...
        webcam_masuk.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 180, 50));
        ...
        webcam_masuk.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 170, 50));

        mainPanel.add(webcam_masuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 200, 390, 410));

        jPanel1.add(mainPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1100, 630));
...
initWebcam_stop();
AbsensiMasuk absen= new AbsensiMasuk();
...
absen.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbsensiKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbsensiKeluar().setVisible(true);
            }
        });
    }
...
//WEBCAM
    ...
    private void initWebcam_keluar() {
                         ...
                         if(status_hadir == false) {
                            ...
                            if(mm < lj ){
                                ...
                                label_JabatanGuru.setText(data[2]);
                                 // foto_guru.setIcon(new ImageIcon(new ImageIcon("G:/FotoGuru/GURU"+data[4]).getImage().getScaledInstance(foto_guru.getWidth(), foto_guru.getHeight(), Image.SCALE_SMOOTH)));
                                ...
                                label_jamkerja.setText("Out : "+jam_sekarang);
                                txtNip.setText("");
                                txtNip.requestFocus();
                            }
                            
                            else {
                         label_error_message.setText("Silahkan Absen Masuk Dahulu");
                        }
                       }
                    }
